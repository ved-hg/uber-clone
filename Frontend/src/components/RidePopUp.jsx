...
const RidePopUp = (props) => {
  return (
   ...
   <p className=' text-gray-600 text-sm mt-[-5px]'>Cash Cash</p></div>
      ...
      <div className='flex mt-5 w-full items-center justify-around'>
      
      <button onClick={()=>{
   props.setridePopupPanel(false)
         
       }}className='  bg-gray-400 px-4 text-gray-700 font-semibold p-3 px-8
...
}}className='  bg-green-600 text-white px-4 font-semibold p-3 px-8
rounded-xl  '> Accept</button>
